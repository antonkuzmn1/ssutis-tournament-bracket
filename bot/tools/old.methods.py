...
#
#     _STUDENT = await get_student(update)
...
#         [InlineKeyboardButton(text='Турнир', callback_data='tb_engine')],
#     ]
#     _REPLY_MARKUP = InlineKeyboardMarkup(_KEYBOARD)
#
...
#     _REQUESTS = SESSION.query(Student).filter_by(valid=1)
#
#     _KEYBOARD = [[InlineKeyboardButton(text='В главное меню', callback_data='main_menu')]]
...
#     _STUDENT = SESSION.query(Student).get(_ID)
#
#     _KEYBOARD = [[InlineKeyboardButton(text='В главное меню', callback_data='student_main')]]
#     _REPLY_MARKUP = InlineKeyboardMarkup(_KEYBOARD)
#
#     _TEXT: str = f'''
...
#     _STUDENT = SESSION.query(Student).get(_ID)
#
#     _KEYBOARD = [[InlineKeyboardButton(text='Назад', callback_data='students_list')]]
#     _REPLY_MARKUP = InlineKeyboardMarkup(_KEYBOARD)
#
#     _URL: str = str(_STUDENT.url)
#     _SURNAME: str = str(_STUDENT.surname)
