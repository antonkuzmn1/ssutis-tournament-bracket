...
# from database.models import Student, Bracket
#
#
# async def get_student(update) -> Student:
#     """
#
...
#
#
# def get_level(student: Student):
#     return SESSION.query(Bracket).filter(Bracket.winner == student.id).count()